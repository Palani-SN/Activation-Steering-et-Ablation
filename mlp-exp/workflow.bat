...
echo [6/6] Running Behavior Modelling...
python behavior_modelling.py || (echo Behavior modelling failed & exit /b 1)

echo.
echo ======================================================
echo Pipeline Complete: Behavior Modelling Completed.
echo ======================================================
